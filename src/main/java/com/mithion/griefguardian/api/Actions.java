...
public class Actions {
	...
	public static final int BLOCK_USE = 4;
	public static final int CONTAINER_OPEN = 5;
	public static final int ITEM_PICKUP = 6;
	public static final int ITEM_DROP = 7;
	public static final int ITEM_USE = 8;
	public static final int ITEM_BREAK = 9;
	...
	public static final int ENDERMAN_GRAB = 15;
